...
function setup(app) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!req.query["name"]) return [3 /*break*/, 3];
                    name_1 = req.query["name"];
                    return [4 /*yield*/, product.search_by_name(name_1)];
                case 2:
                    mass_1 = _a.sent();
    ...
    app.post('/product', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var prod, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
