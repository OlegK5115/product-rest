...
describe('api', function () {
    ...
    context('check get requests', function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, history.create(hstory1)];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, history.create(hstory2)];
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, history.create(hstory3)];
                        case 3:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        it("check '/histories' with params", function () {
            return __awaiter(this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, agent
                                .get("/histories?action=".concat(hstory1.action))
